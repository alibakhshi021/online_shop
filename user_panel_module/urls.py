...
urlpatterns = [
    ...
    path('edit-profile/', views.EditUserProfilePageView.as_view(), name='edit_user_panel'),
    ...
    path('change-order-detail', views.change_order_detail_count, name='remove_order_detail'),
]
