...
class SiteSetting(models.Model):
    ...
    phone = models.CharField(max_length=100, null=True, verbose_name='تلفن')
...
class FooterLink(models.Model):
    ...
    footer_link_box = models.ForeignKey(to=FooterLinkBox, on_delete=models.CASCADE, verbose_name='دسته بتدی', related_name='footerlink_set')
...
class SiteBanner(models.Model):
    ...
    url = models.URLField(max_length=500,blank=True, null=True, verbose_name='آدرس بنر')
    image = models.ImageField(upload_to='images/banners', verbose_name='تصویر بنر')
    is_active = models.BooleanField(verbose_name='فعال|غیرفعال')
    position = models.CharField(max_length=200, choices=SiteBannerPosition, verbose_name='جایگاه نمایشی')
